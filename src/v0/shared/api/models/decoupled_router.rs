//! Decoupled Router Models
//!
//! This module provides models for handling responses from Drupal's decoupled router API.
//! The decoupled router resolves frontend paths to their corresponding JSON:API URLs,
//! enabling frontend applications to fetch the appropriate backend resources.
//! It returns metadata about the resolved route including whether it's the homepage,
//! entity information, and the JSON:API endpoint URL.
