...
use crate::adapters::driver::leptos_webui::controllers::portfolio_controller;
use crate::adapters::driver::leptos_webui::views::components::common::GeneralError;
...
pub fn PortfolioPage() -> impl IntoView {
    let page_data = OnceResource::new(portfolio_controller());
            ...
            <Suspense fallback=move || {
                ...
                {move || {
                    page_data
                        ...
                        .map(|data| {
                            if let Err(_) = data {
                                return view! {<GeneralError />}.into_any();
                            }
