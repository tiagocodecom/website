...
pub fn BlogSection(
    ...
    view! {
        <DefaultContainer id="blog".into()>
            <div class="">
                <ContainerSubtitle text=subtitle />
                <ContainerH2Title text=title />
        ...
        <div class="md:flex md:items-start">
            <div class="overflow-hidden relative rounded-lg group flex-shrink-0">
                <img
                    ...
                    class="md:max-w-[340px] transition ease-custom duration-500 group-hover:scale-105 group-hover:blur-[1.5px]"
                />
            ...
            <div class="mt-5 md:pl-7 md:mt-0 flex-grow">
                <span class="text-pColor dark:text-white/70">{format!("Posted on {}", published_at)}</span>
                ...
                <a href=link class="inline-block border border-black border-dashed rounded-full px-6 py-3 mt-3 lg:mt-4 font-mono text-sm hover:bg-black hover:text-white transition ease-out duration-[120ms] dark:text-white dark:border-white dark:hover:bg-white dark:hover:text-black">
                    Read More
                </a>
            </div>
        </div>
