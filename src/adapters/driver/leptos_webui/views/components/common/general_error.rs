    ...
    view! {
        <div class="flex flex-col items-center justify-center p-6 text-center text-gray-800 rounded-lg max-w-md mx-auto">
            ...
            <div class="flex gap-3 mt-4">
                <button class="px-5 py-2 bg-gray-800 text-white font-medium rounded-full shadow-md hover:bg-gray-700 transition duration-200"
                    onclick="location.reload()">
                    Try Again
                </button>
                <button class="px-5 py-2 bg-gray-300 text-gray-800 font-medium rounded-full shadow-md hover:bg-gray-400 transition duration-200"
