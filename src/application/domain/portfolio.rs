...
use crate::application::domain::common::{MetaTags, Document, Image, Project, Timeline};
...
pub mod tests {
    ...
    use crate::application::domain::common::tests::{
        document_fixture, image_fixture, project_fixture, metatags_fixture, timeline_fixture,
    };
